...
1. **客户端创建与连接**
   ...
   - 连接到服务器地址 `tcp://127.0.0.1:8888`

2. **消息发送**
   - 向服务器发送 "Hello from TCP client!" 消息
   - 等待服务器响应
...
```
[INFO] [server.c:67] main(): Starting TCP server...
[INFO] [server.c:84] main(): TCP server created successfully
[INFO] [server.c:99] main(): TCP server started on tcp://127.0.0.1:8888
[INFO] [server.c:102] main(): Server running for 10 seconds...
[INFO] [server.c:56] connect_handler(): Client connected: id=0
[INFO] [server.c:38] message_handler(): Received message: Hello from TCP client!
[INFO] [server.c:46] message_handler(): Sending response: Hello from TCP server!
[INFO] [server.c:56] connect_handler(): Client disconnected: id=0
[INFO] [server.c:111] main(): Stopping TCP server...
[INFO] [server.c:116] main(): TCP server destroyed
```

### 客户端输出

```
[INFO] [client.c:44] main(): Starting TCP client...
[INFO] [client.c:53] main(): TCP client created successfully
[INFO] [client.c:63] main(): Connected to server: tcp://127.0.0.1:8888
[INFO] [client.c:71] main(): Sending message: Hello from TCP client!
[INFO] [client.c:34] message_handler(): Received message: Hello from TCP server!
