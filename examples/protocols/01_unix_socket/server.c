/*
 * server.c - Unix Socket server example
 *
 * This example demonstrates how to create a Unix Socket server using cd-ipc-ssn library.
 */
...
int main(void)
{
    ...
    LOG_INFO("Unix Socket server started on %s", SERVER_NAME);
